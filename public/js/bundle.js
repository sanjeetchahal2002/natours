...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FuamVldDIwMDIiLCJhIjoiY203M2RmZ2JsMGZ2MzJycXozODV0cHM4byJ9.TxFZf_uT2BHkxCzUte80Og';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    //   center: [-118.113491, 34.111745], // starting position [lng, lat]. Note that lat must be set between -90 and 90
    //   zoom: 9, // starting zoom
    style: 'mapbox://styles/sanjeet2002/cm73ey3g501oq01r58kp028zb',
    interactive: false
  });
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Error whiled Logging Out');
        case 10:
        case "end":
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51Qt3yHDgf8XK8DXLTgHijMZJYJKGqJL0uCuIOlrkcyXvO9hp9hqDJikRAKRCkqAmmLkt3V1fupGmM1klM2yXjuQ100IJ50leLZ');
